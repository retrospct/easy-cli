// Code generated by the Encore v1.3.1 client generator. DO NOT EDIT.
...
// Client is an API client for the hypergo-encore-ymi2 Encore application.
type Client struct {
	Hello HelloClient
	Url   UrlClient
}
...
func Environment(name string) BaseURL {
	return BaseURL(fmt.Sprintf("https://%s-hypergo-encore-ymi2.encr.app", name))
}
...
func New(target BaseURL, options ...Option) (*Client, error) {
	...
	base := &baseClient{
		...
		userAgent:  "hypergo-encore-ymi2-Generated-Go-Client (Encore/v1.3.1)",
	}
...
func (c *helloClient) World(ctx context.Context, name string) (resp HelloResponse, err error) {
	...
	_, err = callAPI(ctx, c.base, "POST", fmt.Sprintf("/hello/%s", url.PathEscape(name)), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *urlClient) Get(ctx context.Context, id string) (resp UrlURL, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "GET", fmt.Sprintf("/url/%s", url.PathEscape(id)), nil, nil, &resp)
	if err != nil {
		return
	}
...
func (c *urlClient) Shorten(ctx context.Context, params UrlShortenParams) (resp UrlURL, err error) {
	// Now make the actual call to the API
	_, err = callAPI(ctx, c.base, "POST", "/url", nil, params, &resp)
	if err != nil {
		return
	}
